...
public class Main {
    public static void main(String[] args) {
        Car ladaGranta = new Car("Lada","Granta",1.7, new Driver_B("Sergey", true, 5));
        System.out.println(ladaGranta);
        System.out.println();

        Car audiA850LTDIQuattro = new Car("Audi","A8 50 L TDI quattro",3.0, new Driver_B("Mike", true, 10));
        System.out.println(audiA850LTDIQuattro);
        printInfo(ladaGranta);
        System.out.println();

        Car bmwZ8 = new Car("BMW","Z8",3.0,new Driver_B("Konstantin",true,9));
        System.out.println(bmwZ8);
        printInfo(bmwZ8);
        System.out.println();

        Car kiaSportage4Generation = new Car("Kia","Sportage 4 generation",2.4,new Driver_B("Vladislav",false,0));
        ...
        for (int i = 1; i <= 4; i++) {
            ...
            Bus bus = new Bus("Bus brand " + i, "Bus Brand " + i, 3.5,driver_d);
            printInfo(bus);
            Truck truck = new Truck("Truck brand " + i, "Truck model " + i, 4 + i, new Driver_C("Driver C " + i, true, 6 + i));
            printInfo(truck);
